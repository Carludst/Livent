        ...
        <div class="row">
            ...
            <table class="table">
                ...
                {section name=index loop=$athletes}
                    <tr>
                        <td><a href="/Livent/Athlete/MainPage/{$athletes[index]->getId()}">{$athletes[index]->getId()}</a></td>
                        <td><a href="/Livent/Event/MainPage/{$events[index]->getId()}">{$athletes[index]->getName()}</a></td>
                    </tr>
                {/section}
                </tbody>
            </table>
