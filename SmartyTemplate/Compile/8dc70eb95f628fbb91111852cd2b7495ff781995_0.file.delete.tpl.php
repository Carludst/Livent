<?php
/* Smarty version 4.1.1, created on 2022-07-14 19:25:11
  from 'C:\xampp\htdocs\Livent\SmartyTemplate\Template\delete.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_62d051774441e2_94989209',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8dc70eb95f628fbb91111852cd2b7495ff781995' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Livent\\SmartyTemplate\\Template\\delete.tpl',
      1 => 1657792506,
      2 => 'file',
    ),
  ),
...
function content_62d051774441e2_94989209 (Smarty_Internal_Template $_smarty_tpl) {
?><!--
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="block text-center">
                    ...
                    <h2 class="text-center">Autentificati</h2>
                    <form method="post" class="text-left clearfix" action="<?php echo $_smarty_tpl->tpl_vars['action']->value;?>
" >
                        ...
                        <div class="text-center my-text-transparent">
                            <h5><?php echo $_smarty_tpl->tpl_vars['message']->value;?>
</h5>
                        </div>
                        <div class="text-center">
                            <button type="submit" class="btn btn-main text-center" >Elimina <?php echo $_smarty_tpl->tpl_vars['what']->value;?>
</button>
                        </div>
                    </form>
                    <p class="mt-20">Vuoi tornare alla pagina del <?php echo $_smarty_tpl->tpl_vars['what']->value;?>
 ?<a href="<?php echo $_smarty_tpl->tpl_vars['return']->value;?>
">annulla</a></p>
                </div>
            </div>
        </div>
